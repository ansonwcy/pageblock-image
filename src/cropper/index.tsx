import { application, ControlElement, customElements, Module, Panel, HStack, Image } from '@ijstech/components';
import './index.css';

declare global {
    namespace JSX {
        interface IntrinsicElements {
            ['image-cropper']: ImageCropperElement;
        }
    }
}

export interface ImageCropperElement extends ControlElement {
    img: Image
}

@customElements('image-cropper')
export class ImageCropper extends Module {
    ...
    async init() {
        this.img = this.getAttribute('img', true);
        super.init();
        this.showCropPopUpWindow();
    }
    ...
    showCropPopUpWindow() {
        ...
        let img_uploader = uploader.getElementsByTagName("img")[0];
    ...
    render() {
        return (
            <i-hstack id={'croppingImgPnl'}></i-hstack>
        );
    }
}