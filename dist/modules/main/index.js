...
define("@image/main/index.css.ts", ["require", "exports", "@ijstech/components"], function (require, exports, components_1) {
    ...
    components_1.Styles.cssRule('#cropImgWindow', {
        $nest: {
            ".angle": {
                zIndex: '200',
                position: 'absolute',
...
define("@image/main", ["require", "exports", "@ijstech/components", "@image/main/index.css.ts"], function (require, exports, components_2) {
    ...
    let ImageBlock = class ImageBlock extends components_2.Module {
        ...
        showCropPopUpWindow() {
            ...
            cropperDiv_old === null || cropperDiv_old === void 0 ? void 0 : cropperDiv_old.remove();
            ...
            this.croppingImgPnl.appendChild(this.$render("i-hstack", { id: 'confirmCropHsk', width: '100%', horizontalAlignment: "center", top: canvas.height, padding: { top: '2rem', bottom: '1rem' } },
                this.$render("i-button", { id: 'confirmCropBtn', caption: 'confirm to crop', onClick: () => this.comfirmCrop(this._newX, this._newY, this._newWidth, this._newHeight) })));
        ...
        render() {
            return (this.$render("i-panel", null,
                ...
                this.$render("i-modal", { id: "cropImgWindow", title: 'Crop image', showBackdrop: true, minWidth: '500px', background: { color: "#FFF" }, popupPlacement: "center", closeIcon: { name: "times", fill: "#aaa" } },
                    this.$render("i-panel", { margin: { top: '1rem', bottom: '1rem' } },
                        this.$render("i-hstack", { id: 'croppingImgPnl' }))),
                this.$render("i-panel", { id: "pnlImage" },
                    this.$render("i-upload", { id: "uploader", onChanged: this.handleUploaderOnChange, multiple: true, height: '100%' }),
                    this.$render("i-image", { id: "img", visible: false }),
                    this.$render("i-button", { id: 'cropBtn', caption: 'crop', onClick: this.showCropPopUpWindow, visible: false, margin: { left: '1rem' } }))));
        }
    };
